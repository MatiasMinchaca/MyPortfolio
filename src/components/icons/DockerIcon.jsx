...
const DockerIcon = ({ fill, height, width }) => {
    return (
        <svg width={width} height={height} fill={fill} aria-label="Docker" role="img" viewBox="0 0 512 512">
            <rect width={width} height={height} rx="15%" />
            <path stroke={fill} stroke-width="38"
